...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
      ...
      <div class="w3-section w3-bottombar w3-padding-16">
        ...
        <a href="index.php"><button class="w3-button w3-black"><i class="fa fa-diamond w3-margin-right"></i>Photoshop Designs</button></a>
    ...
    <div class="w3-row-padding">
      <div class="w3-third w3-container w3-margin-bottom">
        <img src="Signage.jpg" alt="Signage" style="width:100%; height: 45vh;" class="w3-hover-opacity">
      <div class="w3-container w3-black">
        <p><b>Store Signage</b></p>
        <p style="text-align: justify;">Concise visual displays conveying information about a business, often used to attract customers and communicate brand identity.</p>
      </div>
    </div>

    <div class="w3-third w3-container w3-margin-bottom">
      <img src="Social Media.jpg" alt="Social Media Banner" style="width:100%; height: 45vh;" class="w3-hover-opacity">
      <div class="w3-container w3-black">
        <p><b>Social Media Banner</b></p>
        <p style="text-align: justify;">A banner for social media promotion to enhance your online presence and captivate your audience with compelling visuals and messages.</p>
      </div>
    </div>

    <div class="w3-third w3-container">
      <img src="Birthday Invitation.jpg" alt="Birthday Invitation" style="width:100%; height: 45vh;" class="w3-hover-opacity">
      <div class="w3-container w3-black">
        <p><b>Birthday Invitation</b></p>
  ...
  <div class="w3-row-padding">
    <div class="w3-third w3-container w3-margin-bottom">
      <img src="Brush Paint.jpg" alt="Brush Paint" style="width:100%; height: 38vh;" class="w3-hover-opacity">
      <div class="w3-container w3-black">
        <p><b>Brush Paint</b></p>
        <p style="text-align: justify;">Unleashing your digital creativity as you craft intricate designs and captivating artwork with a diverse array of virtual brushes and techniques</p>
      </div>
    </div>

    <div class="w3-third w3-container w3-margin-bottom">
      <img src="Tarp. Design.jpg" alt="Tarpaulin Design" style="width:100%; height: 38vh;" class="w3-hover-opacity">
      <div class="w3-container w3-black">
        <p><b>Tarpaulin Design</b></p>
        <p style="text-align: justify;">
            Craft eye-catching tarpaulin designs with innovative graphics and layout for an effective and compelling presentation.</p>
      </div>
    </div>

    <div class="w3-third w3-container">
      <img src="Carteamar.jpg" alt="Carteamar Milk Tea" style="width:100%; height: 38vh;" class="w3-hover-opacity">
      <div class="w3-container w3-black">
        <p><b>Milk Tea Store</b></p>
        <p style="text-align: justify;">Milk Tea Store, where delightful flavors and cozy ambiance come together to offer you a refreshing and enjoyable tea experience.
